...
//    private void createPhysicsBodiesForAllLevels() {
//        int xOffset = 0;
//        System.out.println("mmmmbubxaindihoj");
//        for (int i = 0; i < levels.length; i++) {
//            int[][] levelGrid = levels[i];
//            createPhysicsBodies(levelGrid, xOffset);
//            xOffset += (levelGrid[0].length + 3) * GRID_CELL_SIZE * scaleFactor;
...
//        }
//
////        Sprite red = new Birds(world, 0, 0, 1, stage);
////        Sprite silver = new Birds(world, 210, 240, 2, stage);
////        Sprite terence = new Birds(world, 330, 240, 3, stage);
////        System.out.println("fuct it");
////        stage.getBatch().begin();
////        red.draw(stage.getBatch());
////        silver.draw(stage.getBatch());
////        terence.draw(stage.getBatch());
////        stage.getBatch().end();
//
//        Sprite gullel = new Sprite(gullelTexture);
//        gullel.setPosition(410, 230);
